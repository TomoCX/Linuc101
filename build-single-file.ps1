...
foreach ($f in @('core.js', 'questions.js', 'questions-sec.js', 'commands.js', 'notes.js', 'cards.js', 'notes-view.js', 'cards-view.js', 'glossary.js', 'review-view.js', 'help-view.js', 'sync-view.js', 'app.js')) {
